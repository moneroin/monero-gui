...
<context>
    ...
    <message>
        ...
        <translation>警告：请勿在别的分叉上重用你的 Monero Infinity 私钥，除非这个分叉内置了重用保护，否则隐私会受到侵害。</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>挖矿可增进 Monero Infinity 网络的安全性, 越多使用者的挖矿活动, Monero Infinity 网络就会越难以被攻击. &lt;br&gt; &lt;br&gt;挖矿也让您有机会赚取额外的门罗币, 您的计算机将持续创建哈希值用以寻找区块, 如找到则可以获得该区块所附带的门罗币奖励, 祝您好运！</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>内置 Monero Infinity 版本：</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>使用一个第三方的服务器连接到 Monero Infinity 网络。安全性较低，但更加轻便。</translation>
    </message>
    <message>
        ...
        <translation>可以在搜索引擎中查找“Monero Infinity 远程节点”。请注意确保节点由一个可信任的第三方维护。</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>您在本页面可以操作共享的环签名数据库.  Monero Infinity 钱包以及复制了 Monero Infinity 密钥的克隆钱包都将使用本数据库.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>为了掩盖Monero Infinity交易中任何付款的去向, 第三方不应知道环签名中每个输入和支付的对应关系. 否则就会削弱环签名提供的保护. 如果仅有一个输入之外的所有输入都已知, 那么所有付款的去向将变得透明, 这将使作为Monero Infinity三个主要隐私保护层之一的环签名彻底无效.  &lt;br&gt; 为帮助交易中避免出现这些问题, 可以使用已知去向列表来避免在新交易中使用它们.  这个清单由 Monero Infinity 项目维护, 可在 getmonero.org 网站上找到, 您可以在此处导入此清单. &lt;br&gt; 或者, 您可以自己扫描区块链 (以及复制了 Monero Infinity 密钥的克隆钱包的区块链),  使用monero-blockchain-blackball工具创建已知已用输出的列表. &lt;br&gt;</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>为避免 Monero Infinity 环签名所提供的保护被破坏，某个输出不应在别的链上与别的成员结成一个新环而被再次花费掉（这样会导致产生相同的 key image）。尽管这看上去不是什么问题，但当一个重用密钥的 Monero Infinity 拷贝可以让你重新消费已被消费的输出时，这是个大问题。这里，你必须保证这个已存在的输出在两条链上使用了相同的环。&lt;br&gt;Monero Infinity 和其他一些无意伤害你的隐私的重用 Monero Infinity 私钥的软件会自动处理这些。&lt;br&gt;如果你也在使用一个重用私钥的 Monero Infinity 拷贝，而且这个拷贝没有包含这样的保护，你的交易仍然可以在那个拷贝上得到保护，但你需要手动将环输入到此页中，以便你能在后续安全地花费你的 Monero Infinity。&lt;br&gt;如果你没有使用一个不附带此安全特性的重用私钥的 Monero Infinity 拷贝的话，那么你什么都不用做，一切都是自动的。&lt;br&gt;</translation>
    </message>
    <message>
        ...
        <translation>这个环签名已在密钥重用的Monero Infinity链上使用过, 因此重复使用同一个环签名可以避免隐私问题. </translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>就快完成了 - Monero Infinity 还需要一点设置</translation>
    </message>
    <message>
        <location filename="../wizard/WizardConfigure.qml" line="97"/>
        <source>Kickstart the Monero Infinity blockchain?</source>
        <translation>开始同步 Monero Infinity 区块链?</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>硬盘节约模式能精简区块链的数据而减少硬盘空间的使用量, 但保存完整的区块链能加强 Monero Infinity 网络的安全性, 当您需要在容量较小的硬盘上执行, 那么这个功能就很适合您, 此功能对于网络带宽的用量没有影响. </translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>启动挖矿功能可让 Monero Infinity 的系统网络更加安全, 且在工作完成时获得小额的奖励金. 这个功能只会在计算机插着电源并且闲置时才会自动启动, 当您继续使用计算机后即会停止挖矿. </translation>
    </message>
</context>
<context>
...
<context>
    ...
    <message>
        ...
        <translation>为了能与Monero Infinity网络进行通讯, 您的钱包需要连接上一个Monero Infinity节点. 为了获得最好的隐私, 我们建议您运行一个自己的节点 &lt;br&gt;&lt;br&gt; 如果您无法运行自己的节点, 可以选择连上一个远程的节点. </translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation>Monero Infinity的开发完全由捐赠所支持</translation>
    </message>
    <message>
        <location filename="../wizard/WizardDonation.qml" line="113"/>
        <source>Enable auto-donations of?</source>
        <translation>激活自动捐赠给Monero Infinity的开发团队?</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>在每一笔交易中 Monero Infinity 系统都会收取小额的手续费, 而这个选项则是让你可以增加额外的金额捐赠 Monero Infinity 的开发, 比例以当次交易的手续费为基础计算, 譬如 50% 的自动捐赠意味着如果转账手续费为 0.005XMR时将会额外捐赠 0.0025 XMR 给 Monero Infinity 开发团队. </translation>
    </message>
    <message>
    ...
    <message>
        ...
        <source>Mining secures the Monero Infinity network, and also pays a small reward for the work done. This option will let Monero Infinity mine when your computer is on mains power and is idle. It will stop mining when you continue working.</source>
        <translation>启动挖矿功能可让 Monero Infinity 的网络更加安全, 且在工作完成时获得小额的奖励金. 这个功能只会在计算机插着电源并且闲置时才会自动启动, 当您继续使用计算机后即会停止挖矿. </translation>
    </message>
</context>
<context>
...
<context>
    ...
    <message>
        ...
        <translation>欢迎使用 Monero Infinity！</translation>
    </message>
    <message>
...
Spending address index: </source>
    ...
    <message>
        ...
        <translation>Monero Infinity转账已成功: %1 个交易</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>有可用的新版本 Monero Infinity 钱包:  %1&lt;br&gt;%2</translation>
    </message>
    <message>
